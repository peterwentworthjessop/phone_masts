...
class TestPhoneMasts(unittest.TestCase):
    ...
    def test_requirement_4(self):
        '''Test fourth requirement'''
        expected = [['Potternewton Crescent', 'Potternewton Est Playing Field', '', '', 'LS7', 'Potternewton Est Playing Field', 'Arqiva Ltd', '24/06/1999', '23/06/2019', '20', '6600.00'],
         ['Seacroft Gate (Chase) - Block 2', 'Telecomms Apparatus', 'Leeds', '', 'LS14', 'Seacroft Gate (Chase) block 2-Telecom App.', 'Vodafone Ltd.', '30/01/2004', '29/01/2029', '25', '12250.00'],
         ['Queenswood Heights', 'Queenswood Heights', 'Queenswood Gardens', 'Headingley', 'Leeds', 'Queenswood Hgt-Telecom App.', 'Vodafone Ltd', '08/11/2004', '07/11/2029', '25', '9500.00'],
         ['Armley - Burnsall Grange', 'Armley', 'LS13', '', '', 'Burnsall Grange CSR 37865', 'O2 (UK) Ltd', '26/07/2007', '25/07/2032', '25', '12000.00'],
         ['Seacroft Gate (Chase) - Block 2', 'Telecomms Apparatus', 'Leeds', '', 'LS14', 'Seacroft Gate (Chase) - Block 2, WYK 0414', 'Hutchinson3G Uk Ltd&Everything Everywhere Ltd', '21/08/2007', '20/08/2032', '25', '12750.00']
        ]
        timed_list = self.masts.requirement_4()
        self.assertEqual(timed_list, expected)
